...
namespace OXDesk.Api.Configurations
{
    /// <summary>
    ...
    public static class SwaggerConfiguration
    {
        ...
        public static IServiceCollection AddSwaggerServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = "OX Desk API",
                    Version = "v1",
                    Description = "API for OX Desk system",
                    Contact = new OpenApiContact
                    {
                        Name = "OX Desk Team",
                        Email = "support@oxdesk.com"
                    }
                });
        ...
        public static IApplicationBuilder UseSwaggerMiddleware(this IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (!env.IsProduction())
            {
                ...
                {
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "OX Desk API v1");
                    options.RoutePrefix = "swagger";
                    options.DocumentTitle = "OX Desk API Documentation";
