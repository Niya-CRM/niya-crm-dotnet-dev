...
namespace OXDesk.Application.AuditLogs
{
    public class AuditLogService : IAuditLogService
    {
        ...
        /// <inheritdoc/>
        public async Task<AuditLog> CreateAuditLogAsync(string objectKey, string @event, string objectItemId, string ip, string data, int createdBy, CancellationToken cancellationToken = default)
        {
