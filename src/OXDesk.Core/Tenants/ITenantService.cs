...
public interface ITenantService
{
    ...
    Task<Tenant> CreateTenantAsync(CreateTenantRequest request, int? createdBy = null, CancellationToken cancellationToken = default);
    ...
    Task<Tenant> UpdateTenantAsync(Guid id, UpdateTenantRequest request, int? modifiedBy = null, CancellationToken cancellationToken = default);
