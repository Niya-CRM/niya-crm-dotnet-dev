...
public interface IAuditLogService
{
    ...
    Task<AuditLog> CreateAuditLogAsync(string objectKey, string @event, int objectItemId, string ip, string data, int createdBy, CancellationToken cancellationToken = default);
