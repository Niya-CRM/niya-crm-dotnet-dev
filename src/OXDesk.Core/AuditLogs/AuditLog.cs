...
public class AuditLog : CreationAuditedEntity, IEntity
{
    ...
    public AuditLog(string @event, int objectId, Guid objectItemId, string ip, string? data, int createdBy)
    {
        Event = @event;
        ObjectId = objectId;
    ...
    /// <param name="createdBy">The user who performed the action.</param>
    /// <remarks>TenantId is assigned automatically in ApplicationDbContext before saving.</remarks>
    public AuditLog(string @event, int objectId, int objectItemId, string ip, string? data, int createdBy)
    {
        Event = @event;
        ObjectId = objectId;
