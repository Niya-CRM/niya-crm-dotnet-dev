...
public class AuditLog : CreationAuditedEntity, IEntity
{
    ...
    public AuditLog(string @event, string objectKey, Guid objectItemId, string ip, string? data, int createdBy)
    {
        Event = @event;
        ObjectKey = objectKey;
    ...
    /// <param name="createdBy">The user who performed the action.</param>
    /// <remarks>TenantId is assigned automatically in ApplicationDbContext before saving.</remarks>
    public AuditLog(string @event, string objectKey, int objectItemId, string ip, string? data, int createdBy)
    {
        Event = @event;
        ObjectKey = objectKey;
