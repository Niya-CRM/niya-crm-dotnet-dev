...
public interface IValueListItemRepository
{
    ...
    Task<ValueListItem> ActivateAsync(int id, int modifiedBy, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    Task<ValueListItem> DeactivateAsync(int id, int modifiedBy, CancellationToken cancellationToken = default);
}
