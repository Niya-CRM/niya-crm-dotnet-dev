...
namespace NiyaCRM.Infrastructure.Migrations
{
    ...
    [Migration("20250813192727_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NiyaCRM.Core.Identity.ApplicationUserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("NiyaCRM.Core.Identity.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("NiyaCRM.Core.Identity.RefreshToken", b =>
                {
                    b.HasOne("NiyaCRM.Core.Identity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
